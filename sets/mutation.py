...
num_elements_set_a = int(input())
elements_set_a = set(map(int, input().split()))
num_of_other_sets = int(input())

for _ in range(num_of_other_sets):
    operation, other_set_size = input().split()
    elements_of_other_set = set(map(int, input().split()))
    other_set_size = int(other_set_size)
    
    if operation == "intersection_update":
        elements_set_a.intersection_update(elements_of_other_set)
        
    elif operation == "update":
        elements_set_a.update(elements_of_other_set)
    
    elif operation == "symmetric_difference_update":
        elements_set_a.symmetric_difference_update(elements_of_other_set)
        
    elif operation == "difference_update":
        elements_set_a.difference_update(elements_of_other_set)
