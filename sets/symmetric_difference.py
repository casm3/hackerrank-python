...
elements_of_set_m = set(map(int, input().split()))
size_of_set_n = int(input())
elements_of_set_n = set(map(int, input().split()))

symmetric_difference = sorted(list(elements_of_set_m.symmetric_difference(elements_of_set_n)))
