...
# AVG_SCORE = SUM_OF_STD_SUB_SCORES/TOTAL_NUM_OF_SUB
...
# Marks obtained by student 4: [93,88,90]
...
for _ in range(X_subjects):
    scores_in_subject = list(map(float, input().split()))
    scores_per_subject.append(scores_in_subject)

for scores in zip(*scores_per_subject):
